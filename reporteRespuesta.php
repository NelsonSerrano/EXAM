...
<html lang="es-cl">
	      ...
	      $(document).ready(function(){
	      		...
	      		$('#reporteGlobal').click(function(){
	      			...
	      			if (idExamen == 'Seleccione') {
	      				...
	      				$.post('resultadoResp.php', {idExamen:idExamen,idCurso:idCurso}, function(data){
    ...
    <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
		...
		<div class="row">
			...
			<div class="col-sm-8">
				<center><h4 class="title-reporte">Reporte Respuestas Curso</h4></center>
	...
	<div class="container-fluid">
		<div-row>
			<div class="col-sm-2"></div>
			<div class="col-sm-8 resultadoGlobal" id="resultadoGlobal">
