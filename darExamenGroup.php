...
if (!isset($_SESSION['usuario'])) {
	...
	$grupo =  implode(",", $nombres);
	$largoNombres = count($nombres);
	...
	<!-- fin cabecera -->
		...
		<div class="row">
			...
			<table class="table">
			  <thead>
			    <tr>
			      <th class="cabeza"><?echo $nombre." ".$apellido_paterno." ".$apellido_materno." / ";
			      		for ($i=0; $i < $largoNombres ; $i++) { 
			      				echo $nombres[$i]." / ";
			      		}

			      ?></th>
			      <th class="cabeza"><?echo $nombreExamen;?></th>
			    </tr>
			  </thead>
			  <tbody>
				...
				?>
				<form id="respuestas" action="control/evaluarGroup.php" method="post">
				<!-- <form id="respuestas"> -->
